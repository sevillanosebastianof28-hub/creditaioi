...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
          ...
          <div className="flex items-center justify-between h-20 md:h-24">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <Button 
                ...
                className="bg-primary hover:bg-primary/90 shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 hover:scale-105 transition-all text-sm sm:text-base px-3 sm:px-4"
              >
      ...
      {/* Hero Section */}
      <section className="pt-28 sm:pt-32 md:pt-36 pb-16 sm:pb-20 md:pb-24 px-4 sm:px-6 lg:px-8 relative min-h-screen flex items-center">
        {/* 3D Background */}
        <Hero3D />
        ...
        <div className="container mx-auto relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 
              className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-foreground mb-4 sm:mb-6 leading-[1.1] tracking-tight animate-fade-in"
            ...
            <p 
              className="text-base sm:text-lg md:text-xl text-muted-foreground mb-8 sm:mb-10 max-w-2xl mx-auto leading-relaxed animate-fade-in px-2"
            ...
            {/* Stats */}
            <div 
              className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 max-w-4xl mx-auto animate-fade-in"
              style={{ animationDelay: '0.4s' }}
            >
              {stats.map((stat, index) => (
                <GlowingCard key={index} className="p-4 sm:p-6">
      ...
      <section id="how-it-works" className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 lg:px-8 bg-secondary/30 relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-[300px] sm:w-[600px] h-[300px] sm:h-[600px] bg-primary/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-10 md:gap-8 relative">
              ...
              {workflowSteps.map((item, index) => (
                <div key={index} className="relative text-center group">
                  {/* Step circle */}
                  <div className="inline-flex items-center justify-center w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 rounded-2xl bg-card border-2 border-primary/20 shadow-xl mb-4 sm:mb-6 relative group-hover:border-primary/50 group-hover:shadow-primary/20 transition-all group-hover:scale-105">
                    <span className="text-3xl sm:text-4xl md:text-5xl font-bold text-primary">{item.step}</span>
                    <div className="absolute -top-2 -right-2 sm:-top-3 sm:-right-3 w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-primary text-primary-foreground flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                      {item.icon}
                    </div>
                  </div>
      ...
      <section id="why-us" className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute w-48 sm:w-96 h-48 sm:h-96 bg-primary/10 rounded-full blur-3xl top-1/4 -left-24 sm:-left-48 animate-pulse" />
          <div className="absolute w-40 sm:w-80 h-40 sm:h-80 bg-emerald-500/10 rounded-full blur-3xl bottom-1/4 -right-20 sm:-right-40 animate-pulse" style={{ animationDelay: '1s' }} />
        </div>
        ...
        <div className="container mx-auto relative">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 max-w-6xl mx-auto">
            {advantages.map((advantage, index) => (
              <GlowingCard 
                key={index} 
                className="group hover:-translate-y-2 lg:hover:-translate-y-3 transition-all duration-500"
                glowColor="rgba(16, 185, 129, 0.25)"
              >
                <CardContent className="p-6 sm:p-8 text-center relative overflow-hidden">
                  {/* Floating stat badge */}
                  <div className="absolute top-3 right-3 sm:top-4 sm:right-4 px-2 sm:px-3 py-1 rounded-full bg-primary/10 border border-primary/20">
                    <span className="text-xs sm:text-sm font-bold text-primary">{advantage.stat}</span>
                  </div>
                  
                  {/* Icon with animated background */}
                  <div className="relative inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-gradient-to-br from-primary/20 to-emerald-500/20 mb-4 sm:mb-6 group-hover:scale-110 transition-all duration-300">
          ...
          <div className="text-center mt-10 sm:mt-16">
            <div className="inline-flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 rounded-full bg-secondary/50 border border-border hover:border-primary/30 transition-all group cursor-pointer">
      ...
      <section id="pricing" className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 lg:px-8 bg-secondary/30 relative overflow-hidden">
        <div className="absolute bottom-0 left-0 w-[300px] sm:w-[600px] h-[300px] sm:h-[600px] bg-primary/5 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2" />
              ...
              >
                {plan.popular && (
                  <div className="absolute -top-3 sm:-top-4 left-1/2 transform -translate-x-1/2">
                    <Badge className="bg-primary text-primary-foreground px-3 sm:px-4 py-1 shadow-lg animate-pulse text-xs sm:text-sm">Most Popular</Badge>
                  </div>
                )}
                <CardContent className="p-5 sm:p-6 md:p-8">
                  ...
                  <ul className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                    {plan.features.map((feature, i) => (
                      <li key={i} className="flex items-start gap-2 sm:gap-3 text-sm sm:text-base text-foreground group/item">
                        <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5 text-primary flex-shrink-0 mt-0.5 group-hover/item:scale-110 transition-transform" />
                        <span>{feature}</span>
                      </li>
                    ))}
                  </ul>
                  ...
                  <Button 
                    className={`w-full py-5 sm:py-6 group ${
                      plan.popular 
      ...
      <section className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(255,255,255,0.05)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.05)_1px,transparent_1px)] bg-[size:2rem_2rem] sm:bg-[size:4rem_4rem]" />
        
        {/* Floating shapes - hidden on mobile */}
        <div className="hidden sm:block absolute top-10 left-10 w-16 sm:w-20 h-16 sm:h-20 border border-white/20 rounded-xl rotate-12 animate-pulse" />
        <div className="hidden sm:block absolute bottom-10 right-10 w-24 sm:w-32 h-24 sm:h-32 border border-white/10 rounded-full animate-pulse" style={{ animationDelay: '0.5s' }} />
        <div className="hidden md:block absolute top-1/2 right-1/4 w-16 h-16 border border-white/15 rounded-lg -rotate-12 animate-pulse" style={{ animationDelay: '1s' }} />
        ...
        <div className="container mx-auto text-center relative">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
            <Button 
              size="lg" 
              onClick={() => navigate('/auth')}
              className="bg-white text-primary hover:bg-white/90 px-6 sm:px-8 py-5 sm:py-7 text-base sm:text-lg shadow-xl group hover:scale-105 transition-all w-full sm:w-auto"
            >
              Start Free Trial
            ...
            <Button 
              size="lg" 
              variant="outline"
              className="border-white/30 text-white hover:bg-white/10 px-6 sm:px-8 py-5 sm:py-7 text-base sm:text-lg hover:scale-105 transition-all w-full sm:w-auto"
            >
              Schedule Demo
            </Button>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-5 gap-6 sm:gap-8 mb-8 sm:mb-12">
            <div className="col-span-2">
              ...
              <div className="flex gap-3 sm:gap-4">
                <a href="#" className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-secondary flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-primary hover:text-primary-foreground transition-all hover:scale-110">
